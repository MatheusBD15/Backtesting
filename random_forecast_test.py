...
class RandomForecastingStrategy(Strategy):
    ...
    are randomly generated long/shorts. Nonsensical, solely used for
    testing the backtesting infrastructure"""    
...
def mainTest():
    ...
    cus = rfs.generate_signals()

    # Create a portfolio of SPYs
    portfolio = MarketOnOpenPortfolio(symbol, bars, cus, initial_capital=100000.0)
